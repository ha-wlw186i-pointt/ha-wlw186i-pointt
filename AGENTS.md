...
Home Assistant custom integration (HACS-compatible) for Buderus/Bosch heat pumps (Logatherm WLW186i and similar) via the Bosch Pointt cloud API. Read-only sensor entities only.
